...
#code on how to colour dots for different ranges: https://stackoverflow.com/questions/11467965/r-ggplot2-highlighting-selected-points-and-strange-behavior
```{r}
...
#- We use the guides() fuction to remove the ledengs of a color mapping and a label mapping.
